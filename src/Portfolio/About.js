            ...
            <div class="hero mt-10">
                <div class="hero-content flex-col lg:flex-row ml-12 gap-10">
                    ...
                    <div className='ml-44 mr-20'>
                        ...
                        <a href='Afran Resume.pdf' download><button className='bg-coral px-5 py-1 rounded font-bold'>Download Resume<i class="fa-solid fa-cloud-arrow-down"></i></button></a> <br /> <br />
